...
const testimonials = [
  {
    quote: "Histeeria caught 80% of silent hallucination mistakes before our support agents answered customers. Pure peace of mind.",
    author: "Sarah Chen",
    role: "CTO",
    company: "Meridian Labs",
    metric: { value: "80%", label: "Hallucinations caught" },
  },
  {
    quote: "With multiple autonomous agents executing operations, we had no way of knowing when they drifted. Histeeria gives us unified oversight.",
    author: "Elena Rodriguez",
    role: "VP Engineering",
    company: "Beacon AI",
    metric: { value: "100%", label: "Policy alignment" },
  },
  {
    quote: "The adversarial stress testing was eye-opening. It identified multiple edge-case failure modes in our trading agents.",
    author: "Marcus Webb",
    role: "Head of Trading Systems",
    company: "Flux Systems",
    metric: { value: "12+", label: "Failure modes resolved" },
  },
  {
    quote: "The isolated evaluation transcripts and clear audit trails gave our compliance team the confidence to deploy to production.",
    author: "James Liu",
    role: "CISO",
    company: "Prism Analytics",
    metric: { value: "0", label: "Compliance risks" },
  },
];
