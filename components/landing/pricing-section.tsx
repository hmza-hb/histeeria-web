...
const plans = [
  {
    name: "Start",
    description: "For teams connecting their first production agent",
    ...
    cta: "Start free",
    highlight: false,
    href: "https://app.histeeria.com/login",
  },
  {
    name: "Team",
  ...
  {
    name: "Enterprise",
    description: "For high-stakes agent deployments",
    price: { monthly: 0, annual: 0 },
    features: [
    ...
    cta: "Contact sales",
    highlight: false,
    href: "mailto:legal@histeeria.com",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          ...
          <div className="lg:col-span-5 relative p-0 h-80 lg:h-auto flex items-center justify-center">
            {/* Beautiful floating orbital badge */}
           <h1>$0 for everyone for a limited time</h1>
          </div>
        </div>
                  ...
                  <ul className="space-y-3 mb-10">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <Check className="w-4 h-4 text-[#8f9cff] mt-0.5 shrink-0" />
        ...
        <div className={`mt-20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 ${
          ...
          <div className="flex flex-wrap gap-6 text-sm text-muted-foreground">
            <span className="flex items-center gap-2">
              <Check className="w-4 h-4 text-[#8f9cff]" />
              Encrypted execution
            </span>
            <span className="flex items-center gap-2">
              <Check className="w-4 h-4 text-[#8f9cff]" />
